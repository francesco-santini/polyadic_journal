...
to the compact constraints in $\mathcal{C}$.
...
\begin{table}  %\hfil5
   ...
   \begin{tabular}{llll} 
   %
   \mbox{\bf LA1}& $\frac{\displaystyle  sv(\sigma) \cup sv(c) \subseteq \Delta } {\displaystyle \langle \hbox{\tell}(c), \sigma \rangle \xmapsto{\;  \bot \;}  \langle \hbox{\ostop},
...
{\displaystyle\langle \exists_x A,\sigma\rangle \xmapsto{\bot} \langle A[^w/_x], \sigma\rangle}$
&\bf{Hide}&
